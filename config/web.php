...
$config = [
    ...
    'modules' => [
        ...
        'yii2images' => [
            ...
            'imagesStorePath' => 'upload/image_store', //path to origin images
            'imagesCachePath' => 'upload/image_cache', //path to resized copies
    ...
    'components' => [
        'request' => [
            ...
            'cookieValidationKey' => 'SmlL8hyeJS0JK6BC0lWU1-J5e6LEpCiq',
            'baseUrl'=> '',
        ],
        'authManager' => [
            'class' => 'yii\rbac\PhpManager',
            'defaultRoles' => ['admin', 'client'], // Здесь нет роли "guest", т.к. эта роль виртуальная и не присутствует в модели UserExt
        ],
        'cache' => [
